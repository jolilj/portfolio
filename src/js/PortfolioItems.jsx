...
module.exports = {
  ...
  PORTFOLIO: {
    ...
    text: (
        <div>
          <div className="modal-text">
            <p>Portfolio site written in <a href="https://facebook.github.io/react/">ReactJS</a> (and <a href="https://nodejs.org/en/">NodeJS</a>).
            &nbsp;along with some help from&nbsp;
            <a href="https://webpack.github.io/">Webpack</a> and&nbsp;
            <a href="http://lesscss.org/">LESS</a></p>
          </div>
          <img src={portfolio} className="modal-big-image"/>
        </div>),
    footer: (
      <div className="modal-footer">
